...
I think my design for the emailIntro is solid, as it provides a pretty straightforward experience with simple questions for the user, then does the rest of the work behind the scene when it saves a file on their computer for later usage. I think that design choice makes this pretty idiot-proof, regardless of the client's knowledge of programming or of the tool.
